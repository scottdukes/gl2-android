...
public class AndroidGL20 implements GL20
{
	...
	public native void glGetActiveAttrib ( int program, int index, int bufsize, Buffer length, IntBuffer size, Buffer type, String name );

	public native void glGetActiveUniform ( int program, int index, int bufsize, Buffer length, IntBuffer size, Buffer type, String name );
	...
	public native void glGetProgramInfoLog ( int program, int bufsize, Buffer length, String infolog );
	...
	public native void glGetShaderInfoLog ( int shader, int bufsize, Buffer length, String infolog );
	...
	public native char glIsBuffer ( int buffer );

	public native char glIsEnabled ( int cap );

	public native char glIsFramebuffer ( int framebuffer );

	public native char glIsProgram ( int program );

	public native char glIsRenderbuffer ( int renderbuffer );

	public native char glIsShader ( int shader );

	public native char glIsTexture ( int texture );
